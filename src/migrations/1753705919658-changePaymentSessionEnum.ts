...
export class ChangePaymentSessionEnum1753705919658 implements MigrationInterface {
    name = 'ChangePaymentSessionEnum1753705919658'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."payment_session_status_enum" AS ENUM('initiate', 'invalid', 'pending', 'expired', 'success', 'failed', 'completed')`);

...
export class AddWallettandAccountAudit1766544329148 implements MigrationInterface {
    name = 'AddWallettandAccountAudit1766544329148'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."wallet_direction_enum" AS ENUM('in', 'out')`);
        await queryRunner.query(`CREATE TABLE "wallet" ("id" SERIAL NOT NULL, "userId" integer NOT NULL, "amount" numeric(10,2) NOT NULL, "direction" "public"."wallet_direction_enum" NOT NULL, "balance" numeric(10,2) NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_bec464dd8d54c39c54fd32e2334" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "account_audit" ("id" SERIAL NOT NULL, "paymentId" character varying NOT NULL, "percentage" numeric(5,2) NOT NULL, "amount" numeric(10,2) NOT NULL, "balance" numeric(10,2) NOT NULL, "direction" "public"."wallet_direction_enum" NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_2a504b11de85e11afc0cf36ced7" PRIMARY KEY ("id"))`);
        await queryRunner.query(`ALTER TABLE "user_detail" ADD "bankName" character varying`);
        await queryRunner.query(`ALTER TABLE "user_detail" ADD "bankNumber" character varying`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "user_detail" DROP COLUMN "bankNumber"`);
        await queryRunner.query(`ALTER TABLE "user_detail" DROP COLUMN "bankName"`);

...
export class AddUserUsernameAndPaymentFields1765987225333 implements MigrationInterface {
    name = 'AddUserUsernameAndPaymentFields1765987225333'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "user" ADD "username" character varying`);
        await queryRunner.query(`ALTER TABLE "user" ADD CONSTRAINT "UQ_78a916df40e02a9deb1c4b75edb" UNIQUE ("username")`);
        await queryRunner.query(`ALTER TABLE "user" ADD "usernameChangedAt" TIMESTAMP`);
        await queryRunner.query(`ALTER TABLE "payment" ADD "merchantOrderId" character varying`);
        await queryRunner.query(`ALTER TABLE "payment" ADD "isCompleted" boolean NOT NULL DEFAULT false`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "payment" DROP COLUMN "isCompleted"`);
        await queryRunner.query(`ALTER TABLE "payment" DROP COLUMN "merchantOrderId"`);
        await queryRunner.query(`ALTER TABLE "user" DROP COLUMN "usernameChangedAt"`);
